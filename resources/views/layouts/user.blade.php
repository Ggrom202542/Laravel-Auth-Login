            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 mt-3 p-2">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ route('home') }}"><i class="bi bi-house"></i>หน้าหลัก</a>
                        </li><hr>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('user.information') }}"><i class="bi bi-gear"></i>ข้อมูลส่วนตัว</a></li>
                                <li><a class="dropdown-item" href="{{ route('user.accountSettings') }}"><i class="bi bi-gear"></i>การตั้งค่าบัญชี</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
