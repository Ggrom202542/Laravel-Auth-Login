            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 mt-3 p-2">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ route('admin.dashboard') }}"><i class="bi bi-house"></i>หน้าหลัก</a>
                        </li><hr>
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a class="dropdown-item" href="#">
                                        <i class="bi bi-gear"></i>ติดต่อผู้ดูแลระบบ
                                        <img src="{{ asset('images/icon/crown.png') }}" width="16" style="margin: 0 5px 5px 5px" alt="icon">
                                        <span style="color: var(--color-warning); font-size: 12px;">Super Admin</span>
                                    </a>
                                </li>
                            </ul>
                        </li><hr>
